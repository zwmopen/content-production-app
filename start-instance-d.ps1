...
$env:CONTENT_INSTANCE_LABEL = "实例 D · account-4"
$env:PORT = "4334"
$env:TB_REMOTE_DEBUGGING_PORT = "9434"
$env:CONTENT_HTTP_PROXY = "http://127.0.0.1:7897"
$env:TEAMBUILDING_DASHBOARD_RUNTIME = (Join-Path $dataDir "instance-D")
...
$oldConns = Get-NetTCPConnection -LocalPort 4334, 9434 -State Listen -ErrorAction SilentlyContinue
...
Start-Process -FilePath $electronExe -ArgumentList @("--remote-debugging-port=9434", "--no-sandbox", ".") -WorkingDirectory (Join-Path $PSScriptRoot "src")
