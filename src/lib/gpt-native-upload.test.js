...
test("timestamped and numbered duplicate attachment previews match their original filenames", () => {
  const result = reconcileGptAttachmentPaths(
    ["C:\\material\\1.jpg", "C:\\material\\2.jpg"],
    ["移除文件1：1(20260831-045523).jpg", "移除文件2：2 (1).jpg"]
  );
  assert.equal(result.ok, true);
