...
$env:TEAMBUILDING_DASHBOARD_RUNTIME = "D:\AICode\运行数据\江湖有旅人\内容生产App\instance-C"
$env:TEAMBUILDING_SHARED_MATERIAL_ROOT = "D:\AICode\运行数据\江湖有旅人\内容生产App\shared-material"
$env:TB_USER_DATA_ROOT = "D:\AICode\运行数据\江湖有旅人\内容生产App\instance-C\electron-userdata"
...
$proc = Start-Process -FilePath $electronExe -ArgumentList "--remote-debugging-port=9433", "--no-sandbox", "desktop\main.js" -WorkingDirectory (Join-Path $PSScriptRoot "src") -PassThru
Write-Host "Instance C started with PID: $($proc.Id)"
