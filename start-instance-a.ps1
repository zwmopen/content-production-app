...
$env:TEAMBUILDING_DASHBOARD_RUNTIME = (Join-Path $dataDir "instance-A")
...
Start-Process -FilePath $electronExe -ArgumentList @("--remote-debugging-port=9431", "--no-sandbox", ".") -WorkingDirectory (Join-Path $PSScriptRoot "src")
